...
package com.shinemo.publish.debug.jdivisitor;

import org.apache.commons.lang3.Validate;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.shinemo.publish.debug.jdivisitor.event.transform.EventTransformer;
...
class EventThread extends Thread {
	...
	private Logger logger = LoggerFactory.getLogger(EventThread.class);
    ...
    private void handleEvent(Event event) {
    	logger.info("event:"+event.request());
