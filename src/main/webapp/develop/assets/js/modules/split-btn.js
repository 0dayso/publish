...
void function () {
    function SplitButton ( opts ) {
        $.extend(true, this, {
            ...
            /**
             *  panel 只生成一次 当SplitButton 获取焦点的时候动态显示隐藏；
             */
            panel: {
                cls: '',
                groupCls: '',
    ...
    $.extend(Select.prototype, {
        ...
        update: function ( data, f ) {
            data = pSBtn.sortData(this, data || this.data, f);
            this.panelContainer.html(pSBtn.generateGroupHtml(this, data));
        },
        /**
         * reload 重新生成Select;
         */
